...
// int entryNum__Thread_Begin = 0;

void
Thread::Begin ()
{
    // entryNum__Thread_Begin++;
    // cout<< "\n[Thread::Begin()] current thread: " << kernel->currentThread->getName() << "\n";
...
{
    // cout<< "\n[Sleep()] current thread: " << kernel->currentThread->getName() << "\n";
    // cout<< "\n[Sleep()] entryNum__Thread_Begin: " << entryNum__Thread_Begin << "\n";
